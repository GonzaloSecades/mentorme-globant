const initialState = {
  ...
  skillsToTeach: [],
  skillsToLearn: [],
  mentors: [{ objectives: [{ name: "Ver video de React", _id: "1", isCompleted: true }, { name: "practicar Props", _id: "2", isCompleted: false }, { name: "setear estado local", _id: "3", isCompleted: false }] }]
}
