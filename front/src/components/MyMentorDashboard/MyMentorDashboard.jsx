  ...
  const mentors = [
    {
      ...
      objectives: [
        { name: "Ver video de React", _id: "1", isCompleted: true },
        { name: "practicar Props", _id: "2", isCompleted: true },
        { name: "setear estado local", _id: "3", isCompleted: false },
      ],
    },
    {
      _id: 2,
      ...
      avatar: "aca va el avatar",
      objectives: [
        { name: "Ver video de Vue", _id: "1", isCompleted: true },
        { name: "practicar Vue", _id: "2", isCompleted: true },
        { name: "otra task", _id: "3", isCompleted: false },
      ],
    },
  ]
