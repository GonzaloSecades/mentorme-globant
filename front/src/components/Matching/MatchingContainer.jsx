...
export default () => {
  ...
  const handleClickMentorOne = (e) => {
    ...
    if (selectedMentor === mentorOne) {
      axios.patch(`/api/users/${userId}/addMentor`, mentorOne).then((data) => console.log(data.data))
      setFinish(true)
    }
  ...
  const handleClickMentorTwo = (e) => {
    ...
    if (selectedMentor === mentorTwo) {
      axios.patch(`/api/users/${userId}/addMentor`, mentorTwo).then((data) => console.log("HOLA VITTORIO", data.data))
      setFinish(true)
    }
